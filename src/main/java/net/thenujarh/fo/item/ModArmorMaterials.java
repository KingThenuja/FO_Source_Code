...
public class ModArmorMaterials {
    ...
    public static final RegistryEntry<ArmorMaterial> LEAD_ARMOR_MATERIAL = registerArmorMaterial("lead_armor_material", Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
        map.put(ArmorItem.Type.CHESTPLATE, 8);
        map.put(ArmorItem.Type.HELMET, 3);
        map.put(ArmorItem.Type.BODY, 11);
    }), 18, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.0F, 0.1F, () -> Ingredient.ofItems(ModItems.LEAD));
