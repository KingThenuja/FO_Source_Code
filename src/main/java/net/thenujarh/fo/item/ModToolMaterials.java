...
public enum ModToolMaterials implements ToolMaterial {
    RUBY(ModTags.Blocks.INCORRECT_FOR_RUBY_TOOL, 1024, 9.0F, 3.0F, 12, () -> Ingredient.ofItems(ModItems.RUBY)),
    LEAD(ModTags.Blocks.INCORRECT_FOR_LEAD_TOOL, 712, 8.0F, 5.0F, 18, () -> Ingredient.ofItems(ModItems.LEAD));
