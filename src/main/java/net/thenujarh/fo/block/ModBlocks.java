...
public class ModBlocks  {
    ...
    public static final Block LEAD_STAIRS = registerBlock("lead_stairs",
            new StairsBlock(ModBlocks.BLOCK_OF_LEAD.getDefaultState(),
    ...
    public static final Block LEAD_BUTTON = registerBlock("lead_button",
            ...
            .strength(3.5F, 5.0F)
            .sounds(BlockSoundGroup.METAL)
    ));public static final Block LEAD_PRESSURE_PLATE = registerBlock("lead_button",
            new ButtonBlock(BlockSetType.IRON, 2,
                    AbstractBlock.Settings.create()
            .noCollision()
            .requiresTool()
