...
public class ModTrimPattern {
    public static final RegistryKey<ArmorTrimPattern> KAUPENJOE = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(FuturisticOres.MOD_ID, "kaupen"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.KAUPENJOE_SMITHING_TEMPLATE, KAUPENJOE);
    }
